const rooms = {
  ...
  3: {
    ...
    size: "35m²",
    price: 65,
    image: require("../assets/rooms-images/room-3.png"),
    included: [
      "Fresh air window view",
      "Private potty area",
    ...
    reviews: [
      {
        ...
        stars: 5,
        review:
          "Our pup had the best time sniffing around the garden. Loved it!",
      },
      {
        name: "Dana Sela",
        stars: 4,
  ...
  4: {
    ...
    size: "40m²",
    price: 90,
    image: require("../assets/rooms-images/room-4.png"),
    included: [
      "Soft orthopedic bed",
  ...
  5: {
    ...
    size: "60m²",
    price: 100,
    image: require("../assets/rooms-images/room-5.png"),
    included: [
